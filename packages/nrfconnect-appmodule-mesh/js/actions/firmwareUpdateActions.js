...
function _updateFirmware(dispatch, getState, adapter) {
    return new Promise((resolve, reject) => {
        ...
        const hexPath = remote.getGlobal('hexPath');

        const pathHexS130 = path.resolve(hexPath, './hex/connectivity_115k2_with_s130_2.0.1.hex');
        const pathHexS132 = path.resolve(hexPath, './hex/connectivity_115k2_with_s132_2.0.1.hex');
