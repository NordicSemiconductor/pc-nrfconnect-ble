...
There are two main options for responding to update requests: Letting the Bluetooth Low Energy app accept the request automatically (default) or responding to the request manually.
