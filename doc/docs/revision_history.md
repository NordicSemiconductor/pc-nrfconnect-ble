...
| September 2019   | Updated to match the Bluetooth Low Energy app v2.3.1:<br/><br/>- Updated [Installing the Bluetooth Low Energy app](index.md#installing-the-ble-app)<br/>- Clarified supported devices |
| May 2019   | - Updated [Installing the Bluetooth Low Energy app](index.md#installing-the-ble-app)<br/>- Editorial changes |
